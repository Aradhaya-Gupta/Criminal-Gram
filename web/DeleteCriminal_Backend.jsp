...
<html>
    ...
    if(id1.equals(empty))
        ...
        RequestDispatcher rd=request.getRequestDispatcher("DeleteCriminal.jsp");
 ...
 Class.forName("com.mysql.jdbc.Driver");
        ...
        try{
        pstm= cn.prepareStatement("Delete from criminals where id=? AND city=?");
        pstm.setInt(1, id);
        ...
        %><h1>Criminal deleted</h1><%
                   ...
                   out.println(e.toString());
                     ...
                     out.println("Enter Valid id not existr");
                                 }
            } 
    %>
