<%-- 
    Document   : AdminMain
    Created on : Nov 29, 2018, 5:14:00 PM
  ...
  background-size: 100%;
    ...
    <body>
        ...
        <table style="width: 100%; border-style: solid; background-color: bisque">
            <tr>
                <td><a href="PresentCriminals.jsp">Check Present Criminals</a></td>
                <td><a href="DeleteCriminal.jsp">Delete Criminals</a></td>
                <td><a href ="AddCriminal.jsp">Add Criminal</a></td>
            </tr>
        </table>
