  ...
  background-size: 100%;
    ...
    <body><center>        
        <form action="AddCriminal_Backend.jsp" method="POST">
            ...
            <table style="border-style: solid; border-color: black; background-color: red">
                ...
                <tr> <td>age</td><td><input type="number" name="age" placeholder="Enter Age" min="1" /></td></tr>
                 <tr><td>Convicted date</td><td><input type="date" name="adate"/></td></tr>
                  <tr><td>Release date</td><td><input type="date" name="ddate"/></td></tr>
