    ...
    <body bgcolor="white">
        ...
        PreparedStatement pstm;
         String city= (String)session.getAttribute("city");
                ...
                pstm= cn.prepareStatement("select criminal_name,crime,age,arrival_date,release_date,id from criminals where city=?");
                 pstm.setString(1,city);
                 //pstm.setString(2, status);
                 rs= pstm.executeQuery();
         if(rs.next()){
        out.println("<table>");
out.println("<tr><th>Criminal Name</th><th>crime</th><th>age</th><th>arrival time</th><th>release time</th><th>Id</th></tr>");
do{
    out.println("<tr>");
    ...
    out.println("</table>");
            ...
            out.println("Criminal Free District");
